# Sayansi: Kitabu cha Mwanafunzi Darasa la Tatu — ADT Bundle Reference
...
**Sayansi: Kitabu cha Mwanafunzi Darasa la Tatu** — Hiki ni kitabu cha Sayansi cha mwanafunzi wa Darasa la Tatu kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo kinatoka Tanzania na kimeandikwa kwa lugha ya Kiswahili kwa ngazi ya shule ya msingi ya mwanzo. Kinafundisha dhana za msingi za sayansi kama milango ya fahamu, viumbehai na vitu visivyo hai, uchunguzi wa kisayansi, pamoja na michezo sahili ya TEHAMA, kwa lengo la kujenga udadisi, uelewa wa mazingira, na uwezo wa kutatua matatizo. Mtazamo wake wa ufundishaji ni wa vitendo na shirikishi, ukitumia majaribio, kazi za kufanya, picha, na mazoezi ili kuwasaidia wanafunzi kujifunza kwa hatua na kwa uzoefu wa moja kwa moja.
...
├── SAYANSI-STD-3.db                    # SQLite database (pipeline state)
├── SAYANSI-STD-3.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg008_im002` |
...
{
  "pg001_gp001_tx001": "",
  "pg008_im002": "Msichana akipima uzito wa kifurushi kwa mizani ya kuning’inia na kuandika matokeo.",
  "gl001": "amfibia",
  "gl001_def": "Wanyama wenye uti wa mgongo wanaoweza kuishi majini na nchi kavu katika hatua mbalimbali za maisha yao, kama chura.",
  "qz001_que": "Sayansi ni nini?",
  "qz001_o0": "1) Mchezo wa uwanjani",
  "qz001_o0_exp": "❌ Si sahihi. Mchezo ni shughuli ya kucheza, lakini sayansi ni njia ya kujifunza kuhusu vitu na matukio."
}
```
...
```json
{
  "amfibia": {
    "word": "amfibia",
    "definition": "Wanyama wenye uti wa mgongo wanaoweza kuishi majini na nchi kavu katika hatua mbalimbali za maisha yao, kama chura.",
    "variations": ["amfibia"],
    "emoji": "🐸💧🌿"
  }
}
...
```json
{
  "title": "Sayansi: Kitabu cha Mwanafunzi Darasa la Tatu",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw",
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg008_im002" src="images/pg008_im002.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Sayansi ni nini?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Si sahihi. Mchezo ni shughuli ya kucheza, lakini sayansi ni njia ya kujifunza kuhusu vitu na matukio." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Mchezo wa uwanjani</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `SAYANSI-STD-3.pdf` |
| Pipeline database | `SAYANSI-STD-3.db` (SQLite) |
